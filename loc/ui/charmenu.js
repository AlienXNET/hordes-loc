export default {
  ...
  create: {
    ...
    nameReq: {
      ...
      es: 'los nombres solo pueden tener letras (a-z) numeros (0-9) de 3 a 16 carecteres sin espacios.',
  ...
  delete: {
    ...
    info: {
      ...
      es: 'Para eliminar, escribe el nombre del personaje. (una vez borrado tu personaje no podrá ser restaurado).',
