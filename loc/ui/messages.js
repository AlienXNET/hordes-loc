export default {
  ...
  clanMemberApply: {
    ...
    es: '$1 ha solicitado entrar al clan.',
  ...
  clanKickYou: {
    ...
    es: 'Has sido expulsado del clan.',
  ...
  partyMemberInvite: {
    ...
    es: '$2 ha invitado a $1 a unirse al equipo',
  ...
  partyInvitationDecline: {
    ...
    es: '$1 ha rechazado unirse al equipo.',
  ...
  partyInviteLink: {
    ...
    es: '$1 ha creado un link de invitación al equipo: $2.',
  ...
  partyKickOther: {
    ...
    vi: '$1 đã bị đá ra khỏi đội bởi $2.'
  },
  partyQueueStart: {
  ...
  partyQueueStop: {
    ...
    es: 'Tu equipo ha parado la cola tipo: $1.',
  ...
  auctionSold: {
    ...
    es: 'Tu subasta ha sido vendida y $g$1 ha sido enviado a tu Stash.',
